...
\begin{align}
	&(e^{0})_{a} \wedge \cdots \wedge (e^{3})_{d} (e_\kappa)^{d}
	= \frac{1}{3!} \delta^{0123}_{\beta\mu\nu\kappa} 
	(e^\beta)_{a} \wedge (e^\mu)_{b} \wedge (e^\nu)_{c} . \\
	& (e_\kappa)^{a} (e^{0})_{a} \wedge \cdots \wedge (e^{3})_{d}
	=\frac{1}{3!} \delta^{0123}_{\kappa\beta\mu\nu} 
	(e^\beta)_{b} \wedge (e^\mu)_{c} \wedge (e^\nu)_{d} . 
\end{align}
...
%	\left[(e_\kappa)^{c}\wedge(e_\sigma)^{d}\right] \\
%	=& \delta^{0123}_{\alpha\beta\mu\nu} 
%	(e^{\alpha})_{a} \otimes (e^{\beta})_{b} \otimes (e^{\mu})_{c} \otimes (e^{\nu})_{d} 
%	\left[\delta^{\xi\eta}_{\kappa\sigma}  
%	\otimes(e_\xi)^{c}\otimes(e_\eta)^{d} \right] \\
%	=&\delta^{0123}_{\alpha\beta\mu\nu} \delta^{\xi\eta}_{\kappa\sigma}
%	(e^{\alpha})_{a} \otimes (e^{\beta})_{b} \delta^\mu_\xi \delta^\nu_\eta 
%	=\delta^{0123}_{\alpha\beta\mu\nu} \delta^{\mu\nu}_{\kappa\sigma}
%	(e^{\alpha})_{a} \otimes (e^{\beta})_{b}.
%\end{align*}
\begin{align*}
	&(e^{0})_{a} \wedge (e^{1})_{b} \wedge (e^{2})_{c} \wedge (e^{3})_{d} 
